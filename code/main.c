...
/// @param type1 elemento a ser confirmado
/// @param type2 elemento a ser confirmado
...
///
/// Função auxiliares de confirmação de tipo
/// @param t1 elemento a ser confirmado
...
///
/// Função que adiciona dois elementos se forem numeros, uma frase concatenada se forem string ou os menbros de dos arrays e coloca na Stack
...
///
/// Precall para a função read_line
...
///
/// Função que colca na Stack o modulo de um numero
/// @param s Um pointer para a Stack
/// @param vars
...
///
///  Funções Bitwise
///  @see hat(STACK *s) @see and(STACK *s) @see barra(STACK *s) @see til(STACK *s, STACK_Elem *vars)
/// Que retornam sempre 32-bit signed integer
///
...
///
/// Função ( & ) que colaca na Stack um numero apenas quandos os dois elementos são iguais e diferentes de 0
/// @param s Um pointer para a Stack
void and(STACK *s) 
{
    STACK_Elem x = pop(s);
...
///
/// Função ( OR ) que colaca na Stack um numero se um dos elementos for diferente de 0 e se ambos forem 0 retorna 0
/// @param s Um pointer para a Stack
void barra(STACK *s) 
{
    STACK_Elem x = pop(s);
...
///
/// Função ( NOT ) que colaca na Stack os bits invertidos de um numero
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Função que colaca na Stack o segundo elemento se o primeiro não for 0, senão retorna o 3 elemento
/// @param s Um pointer para a Stack
...
///
/// Função que colaca na Stack 1 se os 2 elementos forem iguais e 0 caso contrario
/// @param s Um pointer para a Stack
void equal(STACK *s) 
{
    STACK_Elem x = pop(s);
...
///
/// Função que verifica se o primeiro elemento é maior que o segundo e colaca na Stack 1 caso seja ou 0 caso não
/// @param s Um pointer para a Stack
...
///
/// Função que verifica se o primeiro elemento é menor que o segundo e colaca na Stack 1 caso seja ou 0 caso não
/// @param s Um pointer para a Stack
void minor(STACK *s) 
{
    STACK_Elem y = pop(s);
...
///
/// Função que verifica se o primeiro elemento é maior que o segundo e colaca na Stack o maior
/// @param s Um pointer para a Stack
...
///
/// Função que verifica se o primeiro elemento é menor que o segundo e colaca na Stack o menor
/// @param s Um pointer para a Stack
void eMinor(STACK *s) 
{
    STACK_Elem y = pop(s);
...
///
/// Função que colaca na Stack 1 caso o elemento seja 0 e colaca na Stack 0 caso seja qualquer outro numero
/// @param s Um pointer para a Stack
...
///
/// Função que colaca na Stack 0 caso um dos dois elementos sejam 0 e colaca na Stack o primeiro caso contrario
/// @param s Um pointer para a Stack
...
///
/// Função que colaca na Stack o segundo elemento caso o primeiro elemento seja 0 e colaca na Stack o primeiro caso contrario
/// @param s Um pointer para a Stack
...
///
/// Coloca no topo da Stack o valor 10
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor 11
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor 12
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor 13
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor 14
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor 15
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor '\n'
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor 0
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor 1
/// @param s Um pointer para a Stack
/// @param vars
...
///
/// Coloca no topo da Stack o valor 2
/// @param s Um pointer para a Stack
/// @param vars
...
/// ou de um ficheiro e interpetá-los usando a Stack
